...
/-- 有限生成ねじれアーベル群は有限である -/
lemma fg_torsion_is_finite (G : Type*) [AddCommGroup G] [AddGroup.FG G]
    [Module.IsTorsion ℤ G] : Finite G :=
...
-/
theorem torsion_module_decomposition (R : Type*) [CommRing R] [IsDomain R]
    [IsPrincipalIdealRing R] (M : Type*) [AddCommGroup M] [Module R M]
    [Module.Finite R M] (hM : Module.IsTorsion R M) :
    ∃ (ι : Type) (_ : Fintype ι) (p : ι → R) (_ : ∀ i, Irreducible (p i)) (e : ι → ℕ),
...
-/
theorem structure_theorem_pid (R : Type*) [CommRing R] [IsDomain R]
    [IsPrincipalIdealRing R] (M : Type*) [AddCommGroup M] [Module R M]
    [Module.Finite R M] :
    ∃ (n : ℕ) (ι : Type) (_ : Fintype ι) (p : ι → R) (_ : ∀ i, Irreducible (p i)) (e : ι → ℕ),
...
-/
theorem structure_theorem_fg_abelian (G : Type*) [AddCommGroup G] [AddGroup.FG G] :
